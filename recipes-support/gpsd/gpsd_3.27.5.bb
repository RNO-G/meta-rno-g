...
inherit scons python3-dir python3native systemd  pkgconfig
...
PACKAGES =+ "libgps python3-pygps gpsd-udev gpsd-gpsctl gpsd-snmp gps-utils gps-utils-python"
